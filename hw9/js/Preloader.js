    ...
    return {
        ...
        preload: function () {
           ...
           // game.load.image('loading','assets/loadingback.jpg');
            ...
            game.load.image('huoba','assets/huoba.jpg');
            game.load.image('zhaomingdan','assets/zhaomingdan.png');
           ...
           game.load.audio('lettersound', 'assets/lettersound.wav');
             ...
             game.load.audio('break', 'assets/break.wav');
                game.load.audio('welcome', 'assets/kongbumusic.mp3');
                ...
                game.load.image('wutai1','assets/wutai1.png');
                     game.load.image('aixin','assets/lightball.jpg');
             game.load.image('gameoverword','assets/gameoverword.png');
              ...
              game.load.image('savetree','assets/savetree.jpg');
               game.load.image('loading','assets/drakcity.jpg');
                 game.load.image('cao','assets/background.png');
            ...
            game.load.image('loadingphoto','assets/loadingphoto.jpg');
             game.load.image('deadword','assets/deadword.png');
               game.load.image('winphoto','assets/dejiu.jpg');
             game.load.image('wordframe','assets/wordframe.png');
             game.load.image('jiushiwo','assets/saved.png');
       ...
       game.load.spritesheet('player','assets/xiaoniao.png',32,24,3,0,0);
        ...
        game.load.audio('kongbumusic1','assets/kongbumusic1.mp3');
           game.load.audio('getitem','assets/getitem.mp3');

        //  Here we load the rest of the assets our game needs.
        //  As this is just a Project Template I've not provided these assets, swap them for your own.
        game.load.image('titlePage', 'assets/title.jpg');
        game.load.image('black','assets/black.png');
          game.load.image('black1','assets/black1.png');
       ...
       //  game.load.audio('welcome', 'assets/herostart.mp3');
        ...
        //   game.load.audio('laser', 'assets/laser.mp3');
           ...
           game.load.audio('loading', 'assets/drakcity.jpg');
